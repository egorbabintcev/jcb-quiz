...
const data = [
  ...
  ], '<strong>В зависимости от года выпуска будут отличаться запчасти. Например было выпущено несколько двигателей.</strong><p>Если не знаете год выпуска техники, мы подкажем по WhatsApp как определиться.</p>'),
  new PictureRadioQuestion('Где находится требуемая запчасть?', [
    {
      id: v4(),
  ...
  ], '<strong>В зависимости от места нахождения необходимой запчасти</strong><p> можем предложить аналоговые запчасти собственного производства или оригинальные европейского качества</p>'),
